...
// 框架用的工具栏上的按钮ID
typedef enum {
	//CONNECT DIALOG PANEL PAGES
	CONNECT_MYSQL_PARAMS_PAGE_ID = CONFIG_USER + 20,
	CONNECT_SSH_PARAMS_PAGE_ID,
	CONNECT_SSL_PARAMS_PAGE_ID,
} PageId;

// 框架用的工具栏上的按钮ID
typedef enum {
	UNSED_BUTTON_ID = 0,
	HOME_BUTTON_ID = CONFIG_USER + 30,
	DATABASE_BUTTON_ID,
	ANALYSIS_BUTTON_ID,
	VIEW_BUTTON_ID,
	SETTING_BUTTON_ID,
...
typedef enum {
	...
	//LIST VIEW TOOLBAR
	LISTVIEW_EXPORT_BUTTON_ID = CONFIG_USER + 90,
	...
	QDIALOG_YES_BUTTON_ID = CONFIG_USER + 101,
	...
	// HOME PANEL
	HOME_CREATE_CONNECT_BUTTON_ID,
	HOME_MANAGE_CONNECT_BUTTON_ID,

	// ANALYSIS PANEL
	ANALYSIS_SQL_LOG_BUTTON_ID = CONFIG_USER + 150,
	...
	// CONNECTION DIALOG
	CONNECT_CONFIRM_BUTTON_ID,
	CONNECT_CANCEL_BUTTON_ID,
	CONNECT_TEST_BUTTON_ID,
	CONNECT_NEW_BUTTON_ID,
	CONNECT_DEL_BUTTON_ID,
	CONNECT_DUP_BUTTON_ID,
	CONNECT_UP_BUTTON_ID,
	CONNECT_DOWN_BUTTON_ID,
	// connect dialog - ssh params page
	CONNECT_SSH_PRIVATE_KEY_BUTTON_ID,
	// connect dialog - ssl params page
	CONNECT_SSL_CA_CERTIFICATE_BUTTON_ID,
	CONNECT_SSL_CIPHER_BUTTON_ID,
...
// TabView id
typedef enum {
	DATABASE_WORK_TAB_VIEW_ID = CONFIG_USER + 170,
...
typedef enum {
	// TREE VIEW
	TREEVIEW_SELECTED_DB_COMBOBOX_ID = CONFIG_USER + 180,
	//LIST VIEW TOOLBAR
	...
	DATABASE_DIALOG_CONNECT_COMBOBOX_ID,
	DATABASE_DIALOG_CHARSET_COMBOBOX_ID,
	DATABASE_DIALOG_COLLATION_COMBOBOX_ID,
	// DIALOG - DuplicateXXXDialog
	DUPLICATE_SOURCE_CONNECT_COMBOBOX_ID,
	DUPLICATE_SOURCE_DATABASE_COMBOBOX_ID,
	DUPLICATE_SOURCE_TABLE_COMBOBOX_ID,
	DUPLICATE_TARGET_CONNECT_COMBOBOX_ID,
	DUPLICATE_TARGET_DATABASE_COMBOBOX_ID,
	DUPLICATE_TARGET_TABLE_COMBOBOX_ID,

	// QUERY PAGE
	QUERY_PAGE_CONNECT_COMBOBOX_ID,
	QUERY_PAGE_DATABASE_COMBOBOX_ID,
} ComboBoxId;


typedef enum {
	DATABASE_TREEVIEW_ID = CONFIG_USER + 220,
	DATABASE_OBJECTS_TREEVIEW_ID,
	ANALYSIS_NAVIGATION_TREEVIEW_ID,
	
	CONNECT_DIALOG_LEFT_TREE_ID,

	// DULICATE DATABASE DIALOG
	DUPLICATE_DATABASE_TREELISTCTRL_ID,
} TreeViewId;


typedef enum {
	DATABASE_QUERY_EDITOR_ID = CONFIG_USER + 230,
	// LIST VIEW 
	...
	// HOMEPANEL - CONNECT LIST ITEM
	CONNECT_ITEM_USER_LABEL_ID,
	CONNECT_ITEM_HOST_LABEL_ID,

	//SETTINGPANEL 
	FEEDBACK_CONTENT_EDIT_ID,
	FEEDBACK_EMAIL_EDIT_ID,

	// connect dialog - mysql params page
	CONNECT_NAME_EDIT_ID,
	CONNECT_HOST_EDIT_ID,
	CONNECT_USERNAME_EDIT_ID,
	CONNECT_PASSWORD_EDIT_ID,
	CONNECT_PORT_EDIT_ID,
	CONNECT_DATABASES_EDIT_ID,
	CONNECT_SPEC_IDLE_TIMEOUT_EDIT_ID,
	CONNECT_KEEP_ALIVE_EDIT_ID,
	// connect dialog - ssh params page
	CONNECT_SSH_HOST_EDIT_ID,
	CONNECT_SSH_PORT_EDIT_ID,
	CONNECT_SSH_USERNAME_EDIT_ID,	
	CONNECT_SSH_PASSWORD_EDIT_ID,
	CONNECT_SSH_PASSPHRASE_EDIT_ID,
	CONNECT_SSH_PRIVATE_KEY_EDIT_ID,
	// connect dialog - ssl params page
	CONNECT_SSL_CA_CERTIFICATE_EDIT_ID,
	CONNECT_SSL_CIPHER_EDIT_ID,
	CONNECT_SSL_CLIENT_KEY_EDIT_ID,
	CONNECT_SSL_CLIENT_CERTIFICATE_EDIT_ID,

	// database dialog - database name
	DATABASE_NAME_EDIT_ID,
	// DIALOG - DuplicateXXXDialog
	DUPLICATE_NAME_EDIT_ID,
	DUPLICATE_SOURCE_CONNECT_EDIT_ID,
	DUPLICATE_SOURCE_DATABASE_EDIT_ID,
	DUPLICATE_SOURCE_TABLE_EDIT_ID,
	DUPLICATE_SOURCE_OBJECT_EDIT_ID,
	DUPLICATE_TARGET_DATABASE_EDIT_ID,
	DUPLICATE_TARGET_TABLE_EDIT_ID,
	DUPLICATE_TARGET_OBJECT_EDIT_ID,
	DUPLICATE_DDL_PREVIEW_EDIT_ID,
} EditorId;

typedef enum 
{
	// connect dialog - ssh params page
	CONNECT_SSH_HOST_LABEL_ID,
	CONNECT_SSH_PORT_LABEL_ID,
	CONNECT_SSH_USERNAME_LABEL_ID,
	CONNECT_SSH_PASSWORD_LABEL_ID,
	CONNECT_SSH_PASSPHRASE_LABEL_ID,
	CONNECT_SSH_PRIVATE_KEY_LABEL_ID,
	// connect dialog - ssl params page
	CONNECT_SSL_CA_CERTIFICATE_LABEL_ID,
	CONNECT_SSL_CIPHER_LABEL_ID,
	CONNECT_SSL_CLIENT_KEY_LABEL_ID,
	CONNECT_SSL_CLIENT_CERTIFICATE_LABEL_ID,
} LabelId;

typedef enum {
	// QUERY RESULT
	DATABASE_QUERY_LISTVIEW_ID = CONFIG_USER + 260,
...
typedef enum {
	//LIST VIEW TOOLBAR
	LISTVIEW_FORMVIEW_CHECKBOX_ID = CONFIG_USER + 270,
	...
	// connect dialog - mysql params page
	CONNECT_DEFAULT_IDLE_TIMEOUT_CHECKBOX_ID,
	CONNECT_SPEC_IDLE_TIMEOUT_CHECKBOX_ID,
	CONNECT_SAVE_PASSWORD_CHECKBOX_ID,
	CONNECT_USE_COMPRESSED_CHECKBOX_ID,
	CONNECT_READONLY_CHECKBOX_ID,
	// connect dialog - ssh params page
	CONNECT_USE_SSH_TUNNEL_CHECKBOX_ID,
	CONNECT_SSH_PASSWORD_CHECKBOX_ID,
	CONNECT_SSH_SAVE_PASSWORD_CHECKBOX_ID,
	CONNECT_SSH_PUBLIC_KEY_CHECKBOX_ID,
	CONNECT_SSH_SAVE_PASSPHRASE_CHECKBOX_ID,
	// connect dialog - ssl params page
	CONNECT_USE_SSL_ENCRYPT_CHECKBOX_ID,
	CONNECT_SSL_USE_AUTHENTICATION_CHECKBOX_ID,

	// SQL SETTING
	STRUCTURE_ONLY_CHECKBOX_ID,
	DATA_ONLY_CHECKBOX_ID,
	STRUCTURE_DATA_CHECKBOX_ID,
	// LOCK TABLES
	LOCK_TABLES_CHECKBOX_ID,
} CheckBoxId;

typedef enum {
	//LIST VIEW TOOLBAR
	EXPORT_TO_CSV_RADIO_ID = CONFIG_USER + 290,
...
typedef enum {
	//LIST VIEW TOOLBAR
	EXPORT_TO_CSV_GROUPBOX_ID = CONFIG_USER + 300,
...
typedef enum {
	EXPORT_SELECT_FIELDS_LISTBOX_ID = CONFIG_USER + 320,
...
typedef enum {
	// list view copy menu
	COPY_ALL_ROWS_TO_CLIPBOARD_MEMU_ID = CONFIG_USER + 340,
	COPY_SEL_ROWS_TO_CLIPBOARD_MEMU_ID,
	COPY_ALL_ROWS_AS_SQL_MEMU_ID,
	COPY_SEL_ROWS_AS_SQL_MEMU_ID,
	// treeview popup menu for connection
	CONNECTION_REFRESH_MENU_ID,
	CONNECTION_MANAGE_MENU_ID,
	CONNECTION_CREATE_MENU_ID,
	CONNECTION_DELETE_MENU_ID,
	CONNECTION_CREATE_DATABASE_MENU_ID,
	CONNECTION_IMPORT_FROM_SQL_MENU_ID,
	CONNECTION_EXPORT_AS_SQL_MENU_ID,
	// treeview popup menu for database
	DATABASE_CREATE_MENU_ID = CONFIG_USER + 360,
	DATABASE_OPEN_MENU_ID,
	DATABASE_REFRESH_MENU_ID,
	DATABASE_DELETE_MENU_ID,
	DATABASE_DUPLICATE_MENU_ID,
	...
	DATABASE_NEW_PROCEDURE_MENU_ID,
	DATABASE_NEW_FUNCTION_MENU_ID,
	DATABASE_NEW_TRIGGER_MENU_ID,
	DATABASE_NEW_EVENT_MENU_ID,
	DATABASE_PROPERTIES_MENU_ID,

	// treeview popup menu for views
	DATABASE_OPEN_VIEW_MENU_ID,
	DATABASE_ALTER_VIEW_MENU_ID,
	DATABASE_DROP_VIEW_MENU_ID,
	DATABASE_EXPORT_VIEW_DATA_MENU_ID,
	DATABASE_SHOW_VIEW_DATA_MENU_ID,

	// treeview popup menu for store-procedure
	DATABASE_OPEN_PROCEDURE_MENU_ID,
	DATABASE_ALTER_PROCEDURE_MENU_ID,
	DATABASE_DROP_PROCEDURE_MENU_ID,

	// treeview popup menu for function
	DATABASE_OPEN_FUNCTION_MENU_ID,
	DATABASE_ALTER_FUNCTION_MENU_ID,
	DATABASE_DROP_FUNCTION_MENU_ID,

	// treeview popup menu for trigger
	DATABASE_OPEN_TRIGGER_MENU_ID,
	DATABASE_ALTER_TRIGGER_MENU_ID,
	DATABASE_DROP_TRIGGER_MENU_ID,

	// treeview popup menu for event
	DATABASE_OPEN_EVENT_MENU_ID,
	DATABASE_ALTER_EVENT_MENU_ID,
	DATABASE_DROP_EVENT_MENU_ID,

	// treeview popup menu for table
	TABLE_OPEN_MENU_ID = CONFIG_USER + 380,
	...
	SHOW_TABLES_MENU_ID,
	SHOW_VIEWS_MENU_ID,
	SHOW_PROCEDURES_MENU_ID,
	SHOW_FUNCTIONS_MENU_ID,
	SHOW_TRIGGERS_MENU_ID,
	SHOW_EVENTS_MENU_ID,

	// query page templates menu
	TEMPLATES_SELECT_STMT_MEMU_ID  = CONFIG_USER + 480,
	TEMPLATES_INSERT_STMT_MEMU_ID = CONFIG_USER + 481,
	TEMPLATES_UPDATE_STMT_MEMU_ID = CONFIG_USER + 482,
	TEMPLATES_DELETE_STMT_MEMU_ID = CONFIG_USER + 483,
	TEMPLATES_REPLACE_STMT_MEMU_ID = CONFIG_USER + 484,

	TEMPLATES_CREATE_TABLE_STMT_MEMU_ID = CONFIG_USER + 485,
	TEMPLATES_DROP_TABLE_STMT_MEMU_ID = CONFIG_USER + 486,
	TEMPLATES_TRUNCATE_TABLE_STMT_MEMU_ID = CONFIG_USER + 487,
	TEMPLATES_ALTER_TABLE_STMT_MEMU_ID = CONFIG_USER + 488,
	TEMPLATES_RENAME_TABLE_STMT_MEMU_ID = CONFIG_USER + 489,

	TEMPLATES_CREATE_INDEX_STMT_MEMU_ID = CONFIG_USER + 490,
	TEMPLATES_DROP_INDEX_STMT_MEMU_ID = CONFIG_USER + 491,

	TEMPLATES_CREATE_VIEW_STMT_MEMU_ID = CONFIG_USER + 492,
	TEMPLATES_DROP_VIEW_STMT_MEMU_ID = CONFIG_USER + 493,

	TEMPLATES_CREATE_TRIGGER_STMT_MEMU_ID = CONFIG_USER + 494,
	TEMPLATES_DROP_TRIGGER_STMT_MEMU_ID = CONFIG_USER + 495,

	TEMPLATES_WITH_STMT_MEMU_ID = CONFIG_USER + 496,
	...
	ANALYSIS_OPEN_PERF_REPORT_MENU_ID = CONFIG_USER + 510,
	ANALYSIS_DROP_PERF_REPORT_MENU_ID,
} MenuId;

// PostMessage messageId
typedef enum {
	MSG_CONNECTION_CHANGE_NAME_ID = CONFIG_USER + 540, // connection name has change 
	MSG_CONNECTION_CONNECTED_ID, // connection has been connected ,HomePanel/DatabasePanel subscribe this message and handle it
	MSG_CONNECTION_CREATE_ID, // connection has been new ,ConnectDilaog subscribe this message and handle it
	MSG_CONNECTION_REMOVE_ID, // connection has been removed ,HomePanel/DatabasePanel subscribe this message and handle it
	MSG_CONNECTION_MOVE_ID, // connection has been moved up/down ,HomePanel/DatabasePanel subscribe this message and handle it

	MSG_CONNECT_LIST_ITEM_CHECKED_ID, //Send this msg when home panel connection list item being checked, wParam = ConnectListItem.GetId()
	
	MSG_TIMER_MOVE_ID, // QPopAnimate 触发的移动定时器
...
typedef enum {	
	// SETTING
	SETTING_GENERAL_SETTINGS_MENU_ID = CONFIG_USER + 800,
	SETTING_ABOUT_MENU_ID
} ListMenuItemId;

typedef enum {
	// SETTING VIEW ID
	SETTING_GENERAL_SETTINGS_VIEW_ID = CONFIG_USER + 830,
	SETTING_ABOUT_VIEW_ID,
} ViewId;

typedef enum {
	RESULT_STATUSBAR_SQL_PANE_ID = CONFIG_USER + 860,
...
typedef enum {
	QPARAMELEM_EDIT_ELEM_ID = CONFIG_USER + 865,
...
typedef enum {
	FILTER_OP_BUTTON_ID_START = CONFIG_USER + 1124,
	FILTER_OP_BUTTON_ID_END = CONFIG_USER + 1199,
} ButtonIdRank;

typedef enum {
	FORMVIEW_EDIT_ID_START = CONFIG_USER + 1200,
	FORMVIEW_EDIT_ID_END = CONFIG_USER + 1712,
} EditIdRank;

typedef enum {
	PRAGMAS_MENU_ID_START = CONFIG_USER + 1713,
	PRAGMAS_MENU_ID_END = CONFIG_USER + 1900,
} MenuIdRank;

typedef enum {
	DB_LIST_ITEM_ID_START = CONFIG_USER + 1901,
	DB_LIST_ITEM_ID_END = CONFIG_USER + 2900,
} DbListItemIdRank;

typedef enum {
	ANALYSIS_INDEX_COLUMN_CHECKBOX_ID_START = CONFIG_USER + 2901,
	ANALYSIS_INDEX_COLUMN_CHECKBOX_ID_END = CONFIG_USER + 3900,
