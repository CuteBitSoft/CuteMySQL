 ...
 * 
 * @file   ObjectsPageProcedureDelegate.cpp
 * @brief  
 * 
 * @author Xuehan Qin (qinxuehan2018@gmail.com) 
 * @date   2025-01-03
 *********************************************************************/
#include "ObjectsPageProcedureDelegate.h"
#include <cassert>
 ...
 * 
 */
void ObjectsPageProcedureDelegate::loadObjects()
{
	// copy runtime data
	refreshSupplier();
	view->DeleteAllItems();
	UserProcedureList objects;
	try {
		objects = supplier->getUserProcedures();
...
void ObjectsPageProcedureDelegate::createMenu()
{
