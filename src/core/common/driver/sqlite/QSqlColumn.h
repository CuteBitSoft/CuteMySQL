...
public:
     ...
     */
    explicit QSqlColumn(const QSqlStatement::TStatementPtr& aStmtPtr, int aIndex);
     ...
     */
    const std::string getText(const char* apDefaultValue = "") const noexcept;
    /**
...
private:
    QSqlStatement::TStatementPtr    mStmtPtr;  ///< Shared Pointer to the prepared SQLite Statement Object
