...
class UserTableRepository : public BaseUserRepository<UserTableRepository>
{
public:
	UserTableList getAll(uint64_t connectId, const std::string& schema);
	UserTableList getAllDetailList(uint64_t connectId, const std::string& schema);
...
private:
	...
	UserTable toUserTableDetail(sql::ResultSet* rs);
};
